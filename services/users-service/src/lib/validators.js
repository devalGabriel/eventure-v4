...
const updateProfileBody = z.object({
  ...
  email: z.string().email().optional(),        // 👈 nou
...
}).refine((d)=> (d.add && d.add.length) || (d.remove && d.remove.length), 'add or remove required');

module.exports = { userIdParam, updateProfileBody, roleMutationBody };
