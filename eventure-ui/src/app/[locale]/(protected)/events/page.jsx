    ...
    <Stack spacing={2} sx={{ p: 2 }}>
      ...
      <Divider />
        ...
        {rows.map((r) => {
          ...
          const guests =
            r.guestCount !== null && r.guestCount !== undefined
              ? `${r.guestCount} invitați`
              : "";

          return (
            <Card key={r.id} sx={{ textDecoration: "none" }}>
              <CardContent>
                <Stack
                  direction="row"
                  alignItems="center"
                ...
                >
                  ...
                  <Stack direction="row" spacing={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      component={Link}
                      href={`${eventsBasePath}/${r.id}/invitations`}
                    >
                      Invitații
                    </Button>
                    <Button
                      ...
                      variant="outlined"
                      component={Link}
                      href={`${eventsBasePath}/${r.id}/program`}
                    >
                      Program
                    </Button>
                  </Stack>
