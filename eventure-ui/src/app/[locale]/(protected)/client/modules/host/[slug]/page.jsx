...
export default function ModuleHostClientPage() {
...
useEffect(() => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-xl font-semibold mb-4">{mod.manifest?.name}</h1>
      <eventure-module-root data-slug={slug} data-host="client"></eventure-module-root>
    </div>
  );
}
